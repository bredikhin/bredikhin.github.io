...
module.exports = (env, callback) ->
  ...
  defaults =
    ...
    blogFolder: 'blog' # blog (sub)folder
    articles: 'posts' # directory containing contents to paginate
  ...
  getArticles = (contents) ->
    ...
    articles = contents[options.blogFolder][options.articles]._.directories.map (item) -> item.index
